...
namespace Web.Api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult GetAll()
        {
            ...
            var userDtos = _mapper.Map<IList<SystemUsersModel>>(users);
            return Ok(userDtos);
        }


        [HttpPut("{id}")]
        public IActionResult Update(string id, [FromBody]SystemUsersModel systemUsersModel)
        {
            ...
            {
                // save 
                _userService.Update(user, systemUsersModel.Password);
                return Ok(1);
            }
            catch (AppException ex)
            {
